<%
    ...
    def addTriageFormLink = ui.pageLink("kenyadreams", "enterForm", [patientId: currentPatient.patientId, formUuid: triageUuid, appId: currentApp.id, returnUrl: ui.thisUrl()])
